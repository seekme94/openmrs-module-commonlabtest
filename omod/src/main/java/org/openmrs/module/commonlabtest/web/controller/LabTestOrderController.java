...
public class LabTestOrderController {
    ...
    private final String SUCCESS_ADD_FORM_VIEW = "/module/commonlabtest/labTestOrder";

    @Autowired
    CommonLabTestService commonLabTestService;

    @RequestMapping(method = RequestMethod.GET, value = "/module/commonlabtest/labTestOrder.form")
    public String showLabTestTypes(@RequestParam(required = true) Integer patientId, @RequestParam(required = false) Integer testOrderId, ModelMap model) {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/module/commonlabtest/labTestOrder.form")
